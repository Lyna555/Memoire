...
<div class="card-body">
    ...
    <a href="{{ url('/showNames') }}" class="btn btn-sm btn-warning" style="background: rgb(255, 152, 67);color:white;border:none">Add</a>
      ...
      <tbody>
        ...
        <div id="overlay">
          <div style="display:flex; flex-direction:column;justify-content:center;align-items:center;gap:20px;width:30%;height:20%;background:white;border-radius:20px;">
            ...
            <div style="display:flex;flex-direction:row;justify-content:center; gap:20px">
              <a href="{{ url('/destroy/'.$reservation->id) }}" class="btn btn-sm btn-warning" style="background: rgb(224, 54, 54);color:white;border:none">Delete</a>
        ...
        <tr>
            ...
            <td>
              ...
              <a href="{{ url('/editR/'.$reservation->id) }}" class="btn btn-sm btn-warning">Edit</a>
            </td>
        </tr>
        @endforeach
      </tbody>
